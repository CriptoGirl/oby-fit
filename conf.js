...
exports.deviceName = 'Obyte Fitness Bot';
exports.permanent_pairing_secret = 'Fit'; // * allows to pair with any code, the code is passed as 2nd param to the pairing event handler
